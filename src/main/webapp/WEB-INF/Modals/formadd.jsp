    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="modal-title w-100"   id="staticBackdropLabel">Ajouter un Contact</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" ></button>
            </div>
            <div class="modal-body">

                <form:form action="/addcontact" method="post" modelAttribute="contact">
                    <form:input path = "id_Contact"  type="hidden" cssClass="form-control" />
                    <div class="mb-3 d-flex flex-column gap-2">
                        <label for="nom" class="form-label">Nom :</label>
                        <%--<input type="text" class="form-control" id="nom">--%>
                        <td><form:input path = "nom" cssClass="form-control" /></td>
                        <td><form:errors path = "nom" cssClass = "alert-danger alert text-center" /></td>
                    </div>
                    <div class="mb-3 d-flex flex-column gap-2">
                        <label for="prenom" class="form-label">Prenom :</label>
                     <%--   <input type="text" class="form-control" id="prenom">--%>
                        <td><form:input path = "prenom" cssClass="form-control" /></td>
                    ...
                    <div class="mb-3 d-flex flex-column gap-2">
                       ...
                       <%-- <select id="Genre" class="form-select" >
                        ...
                        <form:select path="genre" cssClass="form-select">
                    ...
                    <div class="mb-3 d-flex flex-column gap-2">
                        ...
                        <td><form:input path = "adress" cssClass="form-control" /></td>
                    ...
                    <div class="mb-3 d-flex flex-column gap-2">
                        ...
                        <td><form:input path = "telephone1" cssClass="form-control" /></td>
                    ...
                    <div class="mb-3 d-flex flex-column gap-2">
                        ...
                        <td><form:input path = "telephone2" cssClass="form-control" /></td>
                    ...
                    <div class="mb-3 d-flex flex-column gap-2">
                        ...
                        <td><form:input path = "emailpersonnel" cssClass="form-control" /></td>
                    ...
                    <div class="mb-3 d-flex flex-column gap-2">
                        ...
                        <td><form:input path = "emailprofessional" cssClass="form-control" /></td>
